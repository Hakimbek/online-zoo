...
async function initInfinitePetsCarousel(
    trackId: string,
    prevId: string,
    nextId: string,
    apiUrl: string,
    ...
    try {
        ...
        const data: PetsCarouselData = await response.json();
