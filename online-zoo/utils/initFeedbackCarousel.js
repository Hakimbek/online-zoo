...
const createFeedbackCardHTML = (item) => `
...
`;
function initInfiniteFeedbackCarousel(trackId, prevId, nextId, apiUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        loader === null || loader === void 0 ? void 0 : loader.classList.add('thoughts__loader--hidden');
        const wrappersData = [];
    ...
    `).join('');
        const wrappers = track.querySelectorAll('.thoughts__card-wrapper');
        let step = 0;
        let currentIndex = 1;
